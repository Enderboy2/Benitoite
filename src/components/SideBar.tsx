  ...
  return (
    <div className={`h-screen flex ${open ? "w-fit":"w-16"}`}>
      ...
      <div className={`h-screen  bg-dark-background-2 ease-out duration-300 ${open ? "w-48" : "w-0"}`}>
        <div className={`flex justify-center items-center w-44 h-8  bg-dark-background rounded-lg my-2.5 mx-2 text-text-color text-sm ${open ? "scale-100":"scale-0"}`}><p>{workspace_name}</p></div>
